<?php  return '$cliche = $modx->getService(\'cliche\',\'Cliche\',$modx->getOption(\'cliche.core_path\',null,$modx->getOption(\'core_path\').\'components/cliche/\').\'model/cliche/\',$scriptProperties);
